            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 position-relative">
                    <div class="client-con p-5 mt-5 mt-lg-0 theme-box-shadow">
                        <h4 class="mb-3 fs-6 theme-text-primary">{{ $review['title'] }}</h4>
                        <p class="mb-0 theme-text-accent-two lh-lg small">{{ $review['text'] }}</p>
                        <div class="d-flex flex-column justify-content-center mt-3 pt-3 border-top">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <figure class="mb-0 avatar">
                                        <img src="{{ asset('assets/images/customer/' . $review['avatar']) }}" class="img-fluid" alt="client review">
                                    </figure>
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <span class="mt-2 theme-text-accent-one">{{ $review['name'] }}</span>
                                    <p class="mb-0 theme-text-accent-two small">{{ $review['role'] }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
