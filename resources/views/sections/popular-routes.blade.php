                ...
                <div class="p-3 theme-border-radius border">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-xl-4 col-lg-6">
                            <div class="row align-items-center">
                                <div class="col-sm-auto">
                                    <img class="size-40" src="{{ asset('assets/images/icons/' . $route['icon1']) }}" alt="image">
                                </div>
                                <div class="col">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <div class="fs-6">{{ $route['dep1'] }}</div>
                                            <div class="small theme-text-accent-one">{{ $route['from1'] }}</div>
                                        </div>
                                        <div class="col text-center">
                                            <div class="flightLine"><div></div><div></div></div>
                                            <div class="small theme-text-accent-two">{{ $route['dur1'] }}- Nonstop</div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="fs-6">{{ $route['arr1'] }}</div>
                                            <div class="small theme-text-accent-one">{{ $route['to1'] }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-6 my-5 my-lg-0">
                            <div class="row align-items-center">
                                <div class="col-sm-auto">
                                    <img class="size-40" src="{{ asset('assets/images/icons/' . $route['icon2']) }}" alt="image">
                                </div>
                                <div class="col">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <div class="fs-6">{{ $route['dep2'] }}</div>
                                            <div class="small theme-text-accent-one">{{ $route['from2'] }}</div>
                                        </div>
                                        <div class="col text-center">
                                            <div class="flightLine"><div></div><div></div></div>
                                            <div class="small theme-text-accent-two">{{ $route['dur2'] }}- Nonstop</div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="fs-6">{{ $route['arr2'] }}</div>
                                            <div class="small theme-text-accent-one">{{ $route['to2'] }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-auto">
                            <div class="d-flex justify-content-between">
                                <div class="me-4">
                                    <div class="fs-6">US${{ $route['price'] }}</div>
                                    <div class="small theme-text-accent-one">{{ $route['deals'] }} deals</div>
                                </div>
