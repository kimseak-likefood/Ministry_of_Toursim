...
<section style="padding: 60px 40px; max-width: 800px; margin: 0 auto;">
    ...
    <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="title" value="{{ old('title') }}" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 16px;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <textarea name="content" rows="8" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 16px;">{{ old('content') }}</textarea>
