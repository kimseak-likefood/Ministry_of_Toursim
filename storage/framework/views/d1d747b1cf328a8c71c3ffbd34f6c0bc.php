<div class="form-group border-0">
    ...
    <div class="dropdown" id="<?php echo e($id); ?>">
        ...
        <div class="dropdown-menu" aria-labelledby="<?php echo e($buttonId); ?>">
            <ul class="drop-rest">
                <?php $__currentLoopData = ['Adults' => 'onewayAdult', 'Child' => 'onewayChild', 'Rooms' => 'onewayInfant']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
...
<?php /**PATH C:\Users\dogso\OneDrive\Documents\GitHub\Ministry_of_Toursim\resources\views/partials/search/guest-dropdown.blade.php ENDPATH**/ ?>