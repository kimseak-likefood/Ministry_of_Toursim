...
<section style="padding: 60px 40px; background: white;">
    ...
    <div style="display: flex; align-items: center; gap: 30px; margin-bottom: 40px;">
        ...
        <div>
            ...
            <p style="color: #666; font-size: 20px; line-height: 1.8;">Discover the heart and soul of Cambodia through its magnificent temples, royal palaces, vibrant traditions, and world-class museums. From the awe-inspiring legacy of the Khmer Empire to the colorful customs and warm hospitality of local communities, every destination offers a unique glimpse into the nation's rich heritage. Explore centuries of history, admire traditional arts and architecture.</p>
        </div>
    </div>
    ...
    <div style="display: flex; align-items: center; gap: 30px; margin-bottom: 40px;">
        ...
        <div>
            ...
            <p style="color: #666; font-size: 20px; line-height: 1.8;">Experience the breathtaking natural beauty of Cambodia, where lush forests, rolling mountains, pristine rivers, and hidden waterfalls await discovery. Trek through scenic national parks, explore tranquil lakes, encounter diverse wildlife, and relax in some of the country's most stunning landscapes. From the remote jungles of the Cardamom Mountains to the serene countryside and tropical coastlines.</p>
        </div>
    </div>
