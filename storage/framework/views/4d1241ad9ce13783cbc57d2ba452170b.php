...
<section style="padding: 60px 40px; max-width: 800px; margin: 0 auto;">
    <h2 style="font-size: 32px; margin-bottom: 30px;">Create a new post</h2>
    ...
    <form method="POST" action="<?php echo e(route('posts.store')); ?>" enctype="multipart/form-data">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="title" value="<?php echo e(old('title')); ?>" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 16px;">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <textarea name="content" rows="8" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 16px;"><?php echo e(old('content')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Herd\cs262_midterm_project\resources\views/posts/create.blade.php ENDPATH**/ ?>