...
<?php $__env->startSection('title', 'Siem Reap'); ?>
...
<section style="padding: 60px 40px; background: #f9f9f9;">
    <div style="max-width: 900px; margin: 0 auto; text-align: center;">
        <h2 style="font-size: 32px; margin-bottom: 20px;">About Siem Reap</h2>
...
<section style="padding: 60px 40px; background: white;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 25px; justify-content: center;">
        ...
        <div style="text-align: center; overflow: hidden; border-radius: 15px;">
            <img src="/assets/images/discover sr/caption.jpg" alt="Angkor Wat"
            ...
            <p style="margin-top: 10px; font-size: 16px; font-weight: bold;">Angkor Wat</p>
        </div>
 
        <div style="text-align: center; overflow: hidden; border-radius: 15px;">
            <img src="/assets/images/discover sr/bayon-temple.jpg" alt="Bayon Temple"
                style="width: 350px; height: 250px; object-fit: cover; border-radius: 15px; box-shadow: 0 6px 20px rgba(0,0,0,0.15); transition: transform 0.4s ease;"
                onmouseover="this.style.transform='scale(1.08)'" onmouseout="this.style.transform='scale(1)'">
            <p style="margin-top: 10px; font-size: 16px; font-weight: bold;">Bayon Temple</p>
        </div>
 
        <div style="text-align: center; overflow: hidden; border-radius: 15px;">
            <img src="/assets/images/discover sr/Ta-Prohm.jpg" alt="Ta Prohm"
                style="width: 350px; height: 250px; object-fit: cover; border-radius: 15px; box-shadow: 0 6px 20px rgba(0,0,0,0.15); transition: transform 0.4s ease;"
                onmouseover="this.style.transform='scale(1.08)'" onmouseout="this.style.transform='scale(1)'">
            <p style="margin-top: 10px; font-size: 16px; font-weight: bold;">Ta Prohm</p>
        </div>
 
        <div style="text-align: center; overflow: hidden; border-radius: 15px;">
            <img src="/assets/images/discover sr/tonle_sap_7.jpg" alt="Tonlé Sap Lake"
                style="width: 350px; height: 250px; object-fit: cover; border-radius: 15px; box-shadow: 0 6px 20px rgba(0,0,0,0.15); transition: transform 0.4s ease;"
                onmouseover="this.style.transform='scale(1.08)'" onmouseout="this.style.transform='scale(1)'">
            <p style="margin-top: 10px; font-size: 16px; font-weight: bold;">Tonlé Sap Lake</p>
        </div>
 
        <div style="text-align: center; overflow: hidden; border-radius: 15px;">
            <img src="/assets/images/discover sr/pub_street.jpg" alt="Pub Street"
                style="width: 350px; height: 250px; object-fit: cover; border-radius: 15px; box-shadow: 0 6px 20px rgba(0,0,0,0.15); transition: transform 0.4s ease;"
                onmouseover="this.style.transform='scale(1.08)'" onmouseout="this.style.transform='scale(1)'">
            <p style="margin-top: 10px; font-size: 16px; font-weight: bold;">Pub Street</p>
        </div>
 
        <div style="text-align: center; overflow: hidden; border-radius: 15px;">
            <img src="/assets/images/discover sr/Angkor-Night-Market.jpeg" alt="Angkor Night Market"
                style="width: 350px; height: 250px; object-fit: cover; border-radius: 15px; box-shadow: 0 6px 20px rgba(0,0,0,0.15); transition: transform 0.4s ease;"
                onmouseover="this.style.transform='scale(1.08)'" onmouseout="this.style.transform='scale(1)'">
            <p style="margin-top: 10px; font-size: 16px; font-weight: bold;">Angkor Night Market</p>
        </div>
...
<section style="padding: 60px 40px; background: #f9f9f9;">
    <h2 style="text-align: center; margin-bottom: 40px; font-size: 32px;">Experiences in Siem Reap</h2>
 
    <div style="display: flex; align-items: center; gap: 30px; margin-bottom: 40px;">
        <div style="overflow: hidden; border-radius: 15px; flex-shrink: 0;">
            <img src="/assets/images/discover sr/Banteay-Srei-Lady.jpg" alt="Temple Exploration"
        ...
        <div>
            <h3 style="font-size: 34px; margin-bottom: 15px;">Temple Exploration</h3>
    ...
    <div style="display: flex; align-items: center; gap: 30px; margin-bottom: 40px;">
        <div style="overflow: hidden; border-radius: 15px; flex-shrink: 0;">
            <img src="/assets/images/discover sr/village.jpg" alt="Village & Lake Life"
                style="width: 450px; height: 280px; object-fit: cover; border-radius: 15px; box-shadow: 0 6px 20px rgba(0,0,0,0.15); transition: transform 0.4s ease;"
                onmouseover="this.style.transform='scale(1.08)'" onmouseout="this.style.transform='scale(1)'">
        </div>
        <div>
            <h3 style="font-size: 34px; margin-bottom: 15px;">Village & Lake Life</h3>
            <p style="color: #666; font-size: 20px; line-height: 1.8;">
    ...
    <div style="display: flex; align-items: center; gap: 30px; margin-bottom: 40px;">
        <div style="overflow: hidden; border-radius: 15px; flex-shrink: 0;">
            <img src="/assets/images/discover sr/food.jpg" alt="Khmer Cuisine"
                style="width: 450px; height: 280px; object-fit: cover; border-radius: 15px; box-shadow: 0 6px 20px rgba(0,0,0,0.15); transition: transform 0.4s ease;"
                onmouseover="this.style.transform='scale(1.08)'" onmouseout="this.style.transform='scale(1)'">
        </div>
        <div>
            <h3 style="font-size: 34px; margin-bottom: 15px;">Khmer Cuisine</h3>
            <p style="color: #666; font-size: 20px; line-height: 1.8;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Herd\Ministry_of_Toursim-main\resources\views/pages/siemreap.blade.php ENDPATH**/ ?>