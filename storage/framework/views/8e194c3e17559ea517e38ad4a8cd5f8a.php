        ...
        <div class="col-12">
            <div class="search-pan row mx-0 theme-border-radius">
                ...
                <div class="col-12 col-lg-6 col-xl-3 ps-0 mb-2 mb-lg-0 mb-xl-0 pe-0 pe-lg-2">
                    <?php echo $__env->make('partials.search.guest-dropdown', ['id' => 'myDD5', 'buttonId' => 'travellerInfoOneway31', 'label' => 'Guest'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
...
<?php /**PATH C:\Users\dogso\OneDrive\Documents\GitHub\Ministry_of_Toursim\resources\views/partials/search/holiday.blade.php ENDPATH**/ ?>