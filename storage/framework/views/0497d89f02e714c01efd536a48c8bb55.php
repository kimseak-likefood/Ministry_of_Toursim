    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg py-3 py-lg-0 px-0">
            <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Brand Logo" title="Brand Logo" class="img-fluid">
            </a>
...
<?php /**PATH C:\Users\USER\Herd\cs262_midterm_project\resources\views/partials/header.blade.php ENDPATH**/ ?>