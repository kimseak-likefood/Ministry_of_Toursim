            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4 mb-lg-0">
                <div class="card-wrap">
                    <div class="con-img-wrap m-auto">
                        <img src="<?php echo e(asset('assets/images/recommended/' . $deal['img'])); ?>" class="img-fluid mx-auto d-block" alt="product picture">
                        <div class="offer-tag <?php echo e($deal['tag']); ?>">Best Deal</div>
                        <span class="wishlist-tag"><i class="bi bi-heart"></i></span>
                    </div>
                    <div class="con-wrap mt-4">
                        <h2 class="fs-6 mt-4 fw-bold text-truncate"><?php echo e($deal['title']); ?></h2>
                        <p class="mb-2 theme-text-accent-two small"><?php echo e($deal['loc']); ?></p>
                        <div class="d-flex bottom mb-2">
                            <div class="rating-cover">
                                <span class="p-1 small rounded-1 <?php echo e($deal['rating_bg']); ?> theme-text-white"><?php echo e($deal['rating']); ?></span>
                                <span class="me-2 small theme-text-accent-one">Exceptional</span>
                                <span class="small"><?php echo e($deal['reviews']); ?> reviews</span>
                            </div>
                        </div>
                        <p class="mb-0 theme-text-accent-one">Starting from US$<?php echo e($deal['price']); ?></p>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\dogso\OneDrive\Documents\GitHub\Ministry_of_Toursim\resources\views/sections/recommended.blade.php ENDPATH**/ ?>