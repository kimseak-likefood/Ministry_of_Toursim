<ul class="nav nav-pills cust-pills" id="pills-tab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="pills-oneway-tab" data-bs-toggle="pill"
            ...
            <span class="d-inline-block p-2 rounded-circle bg-white align-middle me-2"></span>
            One Way
        </button>
    </li>
    <li class="nav-item" role="presentation">
...
<?php /**PATH C:\Users\dogso\OneDrive\Documents\GitHub\Ministry_of_Toursim\resources\views/partials/search/flight-subtabs.blade.php ENDPATH**/ ?>