...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('sections.recommended', [
        'deals' => [
            ['img' => '', 'tag' => 'bg-warning', 'title' => 'The Montcalm At Brewery London City', 'loc' => 'Westminster Borough, London', 'rating' => '4.8', 'rating_bg' => 'bg-warning'],
            ['img' => '', 'tag' => 'bg-info', 'title' => 'Flying Over Bali', 'loc' => 'Beautiful Lands, Indonesia'],
            ['img' => '', 'tag' => 'bg-success', 'title' => 'smth', 'loc' => 'Pestminster Worough, USA'],
            ['img' => '', 'tag' => '', 'title' => 'The Beauty of Scotland', 'loc' => 'Mestminster Gorough, UK'],
        ]
    ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->make('sections.special-offers', [
        'offers' => [
    ...
    <?php echo $__env->make('sections.experience', [
        'stats' => [
    ...
    <?php echo $__env->make('sections.popular-routes', [
        'routes' => [
    ...
    <?php echo $__env->make('sections.testimonials', [
        'reviews' => [
    ...
    <?php echo $__env->make('sections.blog', [
        'posts' => [
