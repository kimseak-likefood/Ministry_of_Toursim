            ...
            <div class="search-pan row mx-0 theme-border-radius">
                <div class="col-12 col-lg-4 col-xl-2 ps-0 mb-2 mb-xl-0 pe-0 pe-lg-2">
                    <div class="form-group">
                        <label for="hotelCountry" class="form-label">Country <i class="bi bi-caret-down-fill small"></i></label>
                        <input class="form-control" list="datalistOptions15" id="hotelCountry" placeholder="India">
                ...
                <div class="col-12 col-lg-4 col-xl-2 ps-0 mb-2 mb-xl-0 pe-0 pe-lg-2">
                    <div class="form-group">
                        <label for="hotelLocation" class="form-label">Location <i class="bi bi-caret-down-fill small"></i></label>
                        <input class="form-control" list="datalistOptions7" id="hotelLocation" placeholder="New Delhi">
                ...
                <div class="col-12 col-lg-6 col-xl-3 ps-0 mb-2 mb-lg-0 mb-xl-0 pe-0 pe-lg-2">
                    <?php echo $__env->make('partials.search.guest-dropdown', ['id' => 'myDD4', 'buttonId' => 'travellerInfoOneway', 'label' => 'Guest'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
...
<?php /**PATH C:\Users\dogso\OneDrive\Documents\GitHub\Ministry_of_Toursim\resources\views/partials/search/hotel.blade.php ENDPATH**/ ?>